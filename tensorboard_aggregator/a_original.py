...
python /media/data/GitHub/tensorboard-aggregator/tensorboard_aggregator/a_original.py --subpaths '' --output summary --path /media/data/GitHub/Group-Normalization-Tensorflow/train_dir/first_try/baseline
